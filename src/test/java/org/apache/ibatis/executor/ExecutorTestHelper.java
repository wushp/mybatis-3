...
public class ExecutorTestHelper {
    ...
    public static MappedStatement prepareInsertAuthorMappedStatementWithAutoKey(final Configuration config) {
        ...
        MappedStatement ms = new MappedStatement.Builder(config, "insertAuthor",
                ...
                SqlCommandType.INSERT)
                        ...
                        .cache(authorCache).keyGenerator(Jdbc3KeyGenerator.INSTANCE).keyProperty("id").build();
        return ms;
    }
    ...
    public static MappedStatement prepareSelectOneAuthorMappedStatement(final Configuration config) {
        ...
        final ResultMap rm =
                new ResultMap.Builder(config, "defaultResultMap", Author.class, new ArrayList<ResultMapping>() {
                    {
    ...
    public static MappedStatement prepareSelectDiscriminatedPost(final Configuration config) {
        final TypeHandlerRegistry registry = config.getTypeHandlerRegistry();
        final ResultMap discriminatorResultMap =
                new ResultMap.Builder(config, "postResultMap", HashMap.class, new ArrayList<ResultMapping>() {
                    {
        ...
        MappedStatement ms =
                new MappedStatement.Builder(config, "selectPosts", new StaticSqlSource(config, "SELECT * FROM post"),
    ...
    public static MappedStatement createSelectAuthorWithIDof99MappedStatement(final Configuration config) {
        final TypeHandlerRegistry registry = config.getTypeHandlerRegistry();
        MappedStatement ms =
                new MappedStatement.Builder(config, "selectAuthor",
    ...
    public static MappedStatement prepareComplexSelectBlogMappedStatement(final Configuration config) {
        ...
        final SqlSource sqlSource =
                new StaticSqlSource(config, "SELECT b.id, b.author_id, b.title, a.username, a.password, a.email, a.bio"
                        + " FROM blog b" + " INNER JOIN author a ON b.author_id = a.id" + " WHERE b.id = ?");
        final ParameterMap parameterMap =
                new ParameterMap.Builder(config, "defaultParameterMap", int.class, new ArrayList<ParameterMapping>() {
                    {
                        add(new ParameterMapping.Builder(config, "id", registry.getTypeHandler(int.class)).build());
                    }
                }).build();
        final ResultMap resultMap =
                new ResultMap.Builder(config, "defaultResultMap", Blog.class, new ArrayList<ResultMapping>() {
                    {
    ...
    public static MappedStatement prepareSelectBlogByIdAndAuthor(final Configuration config) {
        ...
        final ParameterMap parameterMap =
                new ParameterMap.Builder(config, "defaultParameterMap", Map.class, new ArrayList<ParameterMapping>() {
                    {
    ...
    public static MappedStatement prepareSelectPostsForBlogMappedStatement(final Configuration config) {
        ...
        final ResultMap tagResultMap =
                new ResultMap.Builder(config, "tagResultMap", Tag.class, new ArrayList<ResultMapping>() {
                    {
        ...
        final ResultMap commentResultMap =
                new ResultMap.Builder(config, "commentResultMap", Comment.class, new ArrayList<ResultMapping>() {
                    {
        ...
        final ResultMap postResultMap =
                new ResultMap.Builder(config, "defaultResultMap", Post.class, new ArrayList<ResultMapping>() {
                    {
                        add(new ResultMapping.Builder(config, "id", "id", registry.getTypeHandler(int.class))
                                .flags(new ArrayList<ResultFlag>() {
                                    {
    ...
    public static MappedStatement prepareSelectPostWithBlogByAuthorMappedStatement(final Configuration config) {
        ...
        config.addResultMap(commentResultMap);
        final ResultMap postResultMap =
                new ResultMap.Builder(config, "postResultMap", Post.class, new ArrayList<ResultMapping>() {
                    {
                        add(new ResultMapping.Builder(config, "id", "id", registry.getTypeHandler(int.class))
                                .flags(new ArrayList<ResultFlag>() {
                                    {
    ...
    public static MappedStatement prepareInsertAuthorMappedStatementWithBeforeAutoKey(final Configuration config) {
        final TypeHandlerRegistry registry = config.getTypeHandlerRegistry();
        final ResultMap rm =
                new ResultMap.Builder(config, "keyResultMap", Integer.class, new ArrayList<ResultMapping>()).build();
