...
public class AutomaticLazyLoadingTest {
    ...
    /**
     * Load an element with 'default' configuration. Expect an exception when none of the 'object
     * methods' is called.
     */
    @Test
    ...
    /**
     * Load an element with 'default' configuration. Expect no exception when one of the 'object
     * methods' is called.
     */
    @Test
    ...
    /**
     * Load an element with 'disabled' configuration. Expect an exception when none of the 'object
     * methods' is called.
     */
    @Test
    ...
    /**
     * Load an element with 'disabled' configuration. Expect an exception when one of the 'object
     * methods' is called. (because calling object methods should not trigger lazy loading)
     */
    @Test
    ...
    /**
     * Load an element with 'enabled' configuration. Expect an exception when none of the 'object
     * methods' is called.
     */
    @Test
    ...
    /**
     * Load an element with 'enabled' configuration. Expect no exception when one of the 'object
     * methods' is called.
     */
    @Test
    ...
    /**
     * Load an element with default configuration and call toString. Expect that the toString triggers
    ...
    private void testScenario(String aConfiguration, boolean anExpectingAnException, Method aMethodToCall)
        ...
        try {
            ...
            if (anExpectingAnException) {
                Assert.fail("Excpected an exception, since " + myMethodCallDescription
                        + " should not trigger lazy loading");
            }
        } catch (Exception anException) {
            if (!anExpectingAnException) {
                Assert.fail("Did not expect an exception, because " + myMethodCallDescription
    ...
    private void openSession(String aConfig) throws Exception {
        final String resource =
                "org/apache/ibatis/submitted/automatic_lazy_loading/ibatis-automatic-lazy-load-" + aConfig + ".xml";
        ...
        try {
            ...
            throw new RuntimeException(
                    "Mapper configuration failed, expected this to work: " + anException.getMessage(), anException);
        }
        ...
        Reader createScriptReader =
                Resources.getResourceAsReader("org/apache/ibatis/submitted/automatic_lazy_loading/create.sql");
