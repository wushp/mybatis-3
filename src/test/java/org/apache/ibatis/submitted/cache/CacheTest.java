...
public class CacheTest {
    ...
    /*
     * Test Plan: 1) SqlSession 1 executes "select * from A". 2) SqlSession 1 closes. 3) SqlSession 2
     * executes "delete from A where id = 1" 4) SqlSession 2 executes "select * from A"
     *
    ...
    /*
     * Test Plan: 1) SqlSession 1 executes "select * from A". 2) SqlSession 1 closes. 3) SqlSession 2
     * executes "delete from A where id = 1" 4) SqlSession 2 executes "select * from A" 5) SqlSession 2
     * rollback 6) SqlSession 3 executes "select * from A"
     *
    ...
    /*
     * Test Plan with Autocommit on: 1) SqlSession 1 executes "select * from A". 2) SqlSession 1 closes.
     * 3) SqlSession 2 executes "delete from A where id = 1" 4) SqlSession 2 closes. 5) SqlSession 2
     * executes "select * from A". 6) SqlSession 3 closes.
     *
