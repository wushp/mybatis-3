...
public class CustomizationTest {
    ...
    public void applyDefaultValueWhenCustomizeDefaultValueSeparator() throws IOException {
        ...
        Assertions.assertThat(((SupportClasses.CustomObjectFactory) configuration.getObjectFactory()).getProperties()
                .getProperty("name")).isEqualTo("default");
    ...
    public void applyPropertyValueWhenCustomizeDefaultValueSeparator() throws IOException {
        ...
        Assertions.assertThat(((SupportClasses.CustomObjectFactory) configuration.getObjectFactory()).getProperties()
                .getProperty("name")).isEqualTo("customObjectFactory");
    ...
    @CacheNamespace(implementation = SupportClasses.CustomCache.class,
