...
/*
 * This class contains tests for issue #84 - where the Jdbc3KeyGenerator needs to know the key
 * column name because it is not the first column in the resultset returned from getGeneratedKeys().
 *
