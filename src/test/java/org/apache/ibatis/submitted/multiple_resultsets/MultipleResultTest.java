 ...
 * 
 * The tests require a local install of PostgreSQL and cannot be run as a part of the normal MyBatis
 * build unless PostreSQL is setup on the build machine as described in setupdb.txt
 * 
 * If PostgreSQL is setup as described in setupdb.txt, then remove the @Ignore annotation to enable
 * the tests.
 *
 */
...
public class MultipleResultTest {
    ...
    public static void setUp() throws Exception {
        Reader reader =
                Resources.getResourceAsReader("org/apache/ibatis/submitted/multiple_resultsets/mybatis-config.xml");
