...
public class DefaultResultHandlerTypeTest {
    ...
    public void testSelectList() throws Exception {
        ...
        try {
            List<Person> list =
                    sqlSession.selectList("org.apache.ibatis.submitted.result_handler_type.PersonMapper.doSelect");
    ...
    public void testSelectMap() throws Exception {
        ...
        try {
            Map<Integer, Person> map =
                    sqlSession.selectMap("org.apache.ibatis.submitted.result_handler_type.PersonMapper.doSelect", "id");
    ...
    private static void initDb(Connection conn) throws IOException, SQLException {
        try {
            Reader scriptReader =
                    Resources.getResourceAsReader("org/apache/ibatis/submitted/result_handler_type/CreateDB.sql");
