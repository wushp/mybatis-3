...
public class InlineCollectionWithDotTest {
    ...
    public void openSession(String aConfig) throws Exception {
        ...
        Reader createScriptReader =
                Resources.getResourceAsReader("org/apache/ibatis/submitted/inline_association_with_dot/create.sql");
    ...
    /*
     * Load an element with an element with and element with a value. Expect that this is possible
     * bij using an inline 'association' map.
     */
    @Test
    ...
    /*
     * Load an element with an element with and element with a value. Expect that this is possible
     * bij using an sub-'association' map.
     */
    @Test
