...
public class IncludePropertyTest {
    ...
    public static void setUp() throws Exception {
        ...
        Reader reader =
                Resources.getResourceAsReader("org/apache/ibatis/submitted/include_property/mybatis-config.xml");
    ...
    public void testSimpleProperty() throws Exception {
        ...
        try {
            List<String> results =
                    sqlSession.selectList("org.apache.ibatis.submitted.include_property.Mapper.selectSimpleA");
    ...
    public void testPropertyContext() throws Exception {
        ...
        try {
            List<Map<String, String>> results =
                    sqlSession.selectList("org.apache.ibatis.submitted.include_property.Mapper.selectPropertyContext");
    ...
    public void testEmptyString() throws Exception {
        ...
        try {
            List<String> results =
                    sqlSession.selectList("org.apache.ibatis.submitted.include_property.Mapper.selectEmptyProperty");
    ...
    public void testPropertyInRefid() throws Exception {
        ...
        try {
            List<String> results =
                    sqlSession.selectList("org.apache.ibatis.submitted.include_property.Mapper.selectPropertyInRefid");
            assertEquals("col_a value", results.get(0));
        } finally {
            sqlSession.close();
        }
    ...
    public void testConfigVar() throws Exception {
        ...
        try {
            List<String> results =
                    sqlSession.selectList("org.apache.ibatis.submitted.include_property.Mapper.selectConfigVar");
    ...
    public void testNestedInclude() throws Exception {
        ...
        try {
            List<String> results =
                    sqlSession.selectList("org.apache.ibatis.submitted.include_property.Mapper.selectNestedInclude");
            assertEquals("a value", results.get(0));
        } finally {
            sqlSession.close();
        }
