...
public class OgnlStaticTest {
     ...
     * [org.hsqldb.jdbc.JDBCConnection@5ae1a5c7] DEBUG [main] - ==> Preparing: SELECT * FROM users WHERE
     * name IN (?) AND id = ? DEBUG [main] - ==> Parameters: 1(Integer), 1(Integer) There are two
     * parameter mappings but DefaulParameterHandler maps them both to input paremeter (integer)
     */
    @Test // see issue #448
