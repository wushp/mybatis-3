...
public class DaoTest {
    ...
    private void checkNonEmptyList(final List<TodoLists> actual) {
        // Assert.assertEquals("[List(1)=[a description(1), a 2nd description(2)], List(2)=[a
        // description(1)]]", actual.toString());
        ...
        // We should have gotten three item objects. The first item from the first list and the
        // first item from
