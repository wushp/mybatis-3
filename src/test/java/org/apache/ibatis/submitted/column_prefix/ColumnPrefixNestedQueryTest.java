...
public class ColumnPrefixNestedQueryTest extends ColumnPrefixTest {
    ...
    protected List<Pet> getPetAndRoom(SqlSession sqlSession) {
        List<Pet> pets =
                sqlSession.selectList("org.apache.ibatis.submitted.column_prefix.MapperNestedQuery.selectPets");
        return pets;
    }
    ...
    protected List<Person> getPersons(SqlSession sqlSession) {
        List<Person> list =
                sqlSession.selectList("org.apache.ibatis.submitted.column_prefix.MapperNestedQuery.selectPersons");
        return list;
    }
