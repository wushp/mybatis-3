...
public abstract class AbstractLazyTest {
    ...
    public void before() throws Exception {
        ...
        Reader reader = Resources
                .getResourceAsReader("org/apache/ibatis/submitted/lazyload_proxyfactory_comparison/mybatis-config-"
        ...
        reader = Resources
                .getResourceAsReader("org/apache/ibatis/submitted/lazyload_proxyfactory_comparison/CreateDB.sql");
