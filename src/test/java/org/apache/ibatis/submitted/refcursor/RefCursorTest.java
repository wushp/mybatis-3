...
/*
 * This class contains tests for refcursors. The tests require a local install of PostgreSQL and
 * cannot be run as a part of the normal MyBatis build unless PostreSQL is setup on the build
 * machine as described in setupdb.txt
 * 
