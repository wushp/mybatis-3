...
public class BatchExecutorException extends ExecutorException {
    ...
    /*
     * Returns the BatchUpdateException that caused the nested executor to fail. That exception
     * contains an array of row counts that can be used to determine exactly which statemtn of the
     ...
     * successful sub-executor executed before the failing executor.
     *
