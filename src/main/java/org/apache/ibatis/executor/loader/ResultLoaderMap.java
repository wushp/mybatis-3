...
public class ResultLoaderMap {
    ...
    public static class LoadPair implements Serializable {
        ...
        public void load() throws SQLException {
            /*
             * These field should not be null unless the loadpair was serialized. Yet in that case this method
        ...
        public void load(final Object userObject) throws SQLException {
            ...
            /*
             * We are using a new executor because we may be (and likely are) on a new thread and executors
             * aren't thread safe. (Is this sufficient?)
             *
