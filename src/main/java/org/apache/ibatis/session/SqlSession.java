...
public interface SqlSession extends Closeable {
    ...
    /**
     * Retrieve a list of mapped objects from the statement key and parameter, within the specified row
     * bounds.
     * 
     * @param <E> the returned list element type
     * @param statement Unique identifier matching the statement to use.
     ...
     * based on one of the properties in the resulting objects. Eg. Return a of Map[Integer,Author] for
    ...
    /**
     * Flushes batch statements and commits database connection. Note that database connection will not
     * be committed if no updates/deletes/inserts were called. To force the commit call
