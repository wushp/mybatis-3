...
public class Configuration {
    ...
    protected ProxyFactory proxyFactory = new JavassistProxyFactory(); // #224 Using internal
                                                                       // Javassist instead of OGNL
    ...
    /*
     * Parses all the unprocessed statement nodes in the cache. It is recommended to call this
     * method once all the mappers are added as it provides fail-fast statement validation.
     */
