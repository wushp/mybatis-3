...
/**
 * Specify the behavior when detects an unknown column (or unknown property type) of automatic
 * mapping target.
 *
 * @since 3.4.0
...
public enum AutoMappingUnknownColumnBehavior {
     ...
     * {@code 'org.apache.ibatis.session.AutoMappingUnknownColumnBehavior'} must be set to
     * {@code WARN}.
     */
    WARNING {
        @Override
    ...
    /**
     * Perform the action when detects an unknown column (or unknown property type) of automatic
     * mapping target.
     * 
