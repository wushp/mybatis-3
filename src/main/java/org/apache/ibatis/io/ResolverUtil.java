 ...
 * {@link #find(org.apache.ibatis.io.ResolverUtil.Test, String)} ()} method and supplying a package
...
public class ResolverUtil<T> {
    ...
    /**
     * A simple interface that specifies how to test classes to determine if they are to be included in
     * the results produced by the ResolverUtil.
     */
    public static interface Test {
        /**
         * Will be called repeatedly with candidate classes. Must return True if a class is to be included
         * in the results, false otherwise.
         */
        boolean matches(Class<?> type);
    }

    /**
     * A Test that checks to see if each class is assignable to the provided class. Note that this test
     ...
     * class, subclasses will be collected. Accumulated classes can be accessed by calling
     * {@link #getClasses()}.
     *
    ...
    /**
     * Scans for classes starting at the package provided and descending into subpackages. Each class is
     * offered up to the Test as it is discovered, and if the Test returns true the class is retained.
