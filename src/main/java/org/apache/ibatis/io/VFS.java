...
public abstract class VFS {
    ...
    /**
     * Adds the specified class to the list of {@link VFS} implementations. Classes added in this manner
     * are tried in the order they are added and before any of the built-in implementations.
     * 
